This project demonstrates various image manipulation techniques using Python's PIL (Pillow) library. The functionalities include edge detection, image resizing, overlaying images, and cropping.
